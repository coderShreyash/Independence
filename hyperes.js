...
document.getElementById("Text").innerHTML="Congrats, You have vast knowledge about your country 🤩"
    ...
    document.getElementById("Text").innerHTML="Well done, You have good knowledge about your country 🥳"
        ...
        document.getElementById("Text").innerHTML="No worries, you can improve yur knowledge 😉"
